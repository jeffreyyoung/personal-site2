...
import MagicElephant from './MagicElephant'
...
export default () => [
	<nav className='blue flex flex-wrap flex-row justify-end'>
		...
		<Link to='/' className='pb3 pb0-ns blue no-underline underline-hover'><span aria-label='boy emoji' role="img">👦</span> About Me</Link>
